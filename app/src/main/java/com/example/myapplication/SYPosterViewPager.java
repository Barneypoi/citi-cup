 ...
 * 循环自动滚动广告
 */
public class SYPosterViewPager extends RelativeLayout {

    private static final int[] TEST_IMAGE_IDS = {R.drawable.image6, R.drawable.image7, R.drawable.image8, R.drawable.image9, R.drawable.image10};
    ...
    public SYPosterViewPager(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public SYPosterViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SYPosterViewPager(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        View parent = inflater.inflate(R.layout.sy_viewpager, this, true);
